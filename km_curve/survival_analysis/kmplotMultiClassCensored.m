function varargout=kmplotMultiClassCensored(varargin)
...
table12 = [tabulate(x(x(:,2)==-1)); tabulate(x(x(:,2)==0))];
table12 = table12(find(table12(:, 1) == 218.01 | table12(:, 1) == 268.01 | table12(:, 1) == 328.01 | table12(:, 1) == 282.01 | table12(:, 1) == 762.01 | table12(:, 1) == 1562.01 | table12(:, 1) == 1126.01), :);
if ~isempty(table12)
